import { Image, StyleSheet, TouchableOpacity, Modal, Switch, View, TextInput, ScrollView, Alert } from 'react-native';
        ...
        <View style={styles.modalOverlay}>
          <ThemedView style={styles.settingsModalContainer}>
            <ThemedView style={styles.modalHeader}>
              <ThemedText style={styles.modalTitle}>Cài đặt tài khoản</ThemedText>
            ...
            <ScrollView style={styles.settingsModalContent}>
              ...
              <ThemedView style={styles.profileHeader}>
                ...
                <ThemedText style={styles.userName}>{personalInfo.name}</ThemedText>
                <ThemedText style={styles.userEmail}>{personalInfo.email}</ThemedText>
              </ThemedView>
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.statsContainer}>
          <ThemedView style={styles.statCard}>
            ...
            <FontAwesome5 name="trophy" size={24} color="#FFD700" style={styles.statIcon} />
          </ThemedView>
          
          <ThemedView style={styles.statCard}>
            <ThemedText style={styles.statNumber}>{stats.completedGoals}/{stats.totalGoals}</ThemedText>
            <ThemedText style={styles.statLabel}>Mục tiêu</ThemedText>
            <FontAwesome5 name="bullseye" size={24} color="#FF6B6B" style={styles.statIcon} />
          </ThemedView>
        </View>
        ...
        <View style={styles.achievementsContainer}>
          {achievements.map((achievement) => (
            <View key={achievement.id} style={styles.achievementItem}>
              <View style={[styles.achievementIconCircle, { backgroundColor: achievement.color }]}>
              ...
              <ScrollView style={styles.modalContent}>
                ...
                <ThemedView style={styles.contactItem}>
                  ...
                  <ThemedView style={styles.contactTextContainer}>
                    <ThemedText style={styles.contactTitle}>Email hỗ trợ</ThemedText>
                ...
                {/* Website Contact */}
                <ThemedView style={styles.contactItem}>
                  <Feather name="globe" size={24} color="#0a7ea4" style={styles.contactIcon} />
                  <ThemedView style={styles.contactTextContainer}>
                    <ThemedText style={styles.contactTitle}>Website</ThemedText>
                    <ThemedText style={styles.contactValue}>www.goalapp.com</ThemedText>
                  </ThemedView>
                </ThemedView>

                {/* Address Contact */}
                <ThemedView style={styles.contactItem}>
                  <Feather name="map-pin" size={24} color="#0a7ea4" style={styles.contactIcon} />
                  <ThemedView style={styles.contactTextContainer}>
                    <ThemedText style={styles.contactTitle}>Địa chỉ</ThemedText>
                    <ThemedText style={styles.contactValue}>123 Đường ABC, Quận XYZ, TP. Hồ Chí Minh</ThemedText>
                  </ThemedView>
                </ThemedView>
              </ScrollView>
